...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['averageReactionTime'])) {
    ...
    $avgReactionTime = $_POST['averageReactionTime']; // исправлено на averageReactionTime
    ...
    if (isset($_SESSION['user_id'])) {
        ...
        $test_type = "Оценка сложных сенсомоторных реакций человека";
        $test_name = "оценка скорости реакции на разные цвета";
        ...
        $_SESSION['guest_avg_reaction_time_color(advanced)'] = $avgReactionTime;
